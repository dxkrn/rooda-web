...
//get data motor termurah
$dataMotorTermurah = getDataMotorTermurah($conn);
$namaMotorTermurah = $dataMotorTermurah['nama'];
$hargaMotorTermurah = substr($dataMotorTermurah['harga'], 0, 2);
$imgMotorTermurah = $dataMotorTermurah['img_src'];
...
<head>
    ...
    <title>Katalog Motor - Rooda</title>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="row mb-5">
                            <div class="col-6 col-lg-6 order-2 order-md-3 order-lg-2 mb-2">
                            ...
                            <div class="col-6 col-lg-6 order-2 order-md-3 order-lg-2 mb-2">
                                <div class="card h-100">
                                    <div class="row row-bordered g-0">
                                        <div class="col-md-8">
                                            <h5 class="card-header m-0 me-2 pb-3">Harga Termurah💳</h5>
                                            <div class="text-center">
                                                <img src="<?= $imgMotorTermurah ?>" width="70%">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="card-body ">
                                                <div class="text-center">
                                                    <h1></h1>
                                                    <h4><?= $namaMotorTermurah ?></h4>
                                                    <h1><?= $hargaMotorTermurah ?></h1>
                                                    <h5>JT-an</h5>
                                                    <h1></h1>
                                                </div>
                                            </div>
